// Single Responsibility Principle: all classes and modules should have only 1 well-defined responsibility.
// Επομένως θα έχω:
// Κλάση 1
// Ένα νήμα DISEASE δημιουργεί περιοδικά (π.χ., κάθε 1 δευτερόλεπτο) ένα τυχαίο
// αριθμό κρουσμάτων από 0 έως k τα οποία απαιτούν νοσηλεία σε εντατική νοσοκομείου.
// Κλάση 2
// Ένα νήμα HOSPITAL θεραπεύει κάποιον αριθμό κρουσμάτων από 0 έως h, όπου h < k, και
// απελευθερώνονται οι αντίστοιχες θέσεις.
// Κλάση 3
// Παράλληλα, θα πρέπει να γίνεται καταγραφή (εκτύπωση) του συνολικού αριθμού
// κρουσμάτων που ανάρρωσαν, και αυτών που δεν βρήκαν θέση στην εντατική.
