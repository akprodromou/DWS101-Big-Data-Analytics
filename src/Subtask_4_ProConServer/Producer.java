...
public class Producer implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            // η εντολή θα έχει ένα prefix (εδώ ADD, στον consumer SUB), ακολουθούμενη από τον αριθμό που θέλουμε να προστεθεί
            String command;
            // Τυχαίος αριθμός μεταξύ 10–100
            int produceAmount = 10 + random.nextInt(91);
            command = "ADD " + produceAmount;
            ...
            try (
                ...
                // ενημέρωσε το ClientHandler πως θα προσθέσουμε
                out.println(command);
